...
pub const LIFINITY_AMM_V1_MIN_ACCOUNTS: usize = 13;
const SWAP_DISCRIMINATOR: [u8; 8] = [248, 198, 158, 145, 225, 117, 135, 200];

pub struct LifinityAmmV1SwapAccounts<'info> {
...
pub fn lifinity_amm_v1_swap<'info>(
    amount_in: u64,
    minimum_amount_out: u64,
    accounts: LifinityAmmV1SwapAccounts<'info>,
) -> Result<SwapResult> {
    ...
    let metas = vec![
        ...
        AccountMeta::new_readonly(*accounts.amm.key, false),
        ...
        AccountMeta::new_readonly(*accounts.pyth_account.key, false),
        AccountMeta::new_readonly(*accounts.pyth_pc_account.key, false),
        AccountMeta::new(*accounts.config_account.key, false),
    ];
    ...
    invoke(
        ...
        &[
            ...
            accounts.pyth_account,
            accounts.pyth_pc_account,
