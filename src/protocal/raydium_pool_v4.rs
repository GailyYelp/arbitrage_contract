...
pub const RAYDIUM_POOL_V4_MIN_ACCOUNTS: usize = 15;
...
pub struct RaydiumPoolV4Accounts<'info> {
    ...
    pub amm_open_orders: &'info AccountInfo<'info>, // 4. amm_open_orders
    pub amm_target_orders: &'info AccountInfo<'info>, // 5. amm_target_orders
...
pub fn raydium_pool_v4_swap<'info>(
    ...
    let metas = vec![
        ...
        AccountMeta::new(accounts.amm_open_orders.key(), false), // 3: amm_open_orders_info
        AccountMeta::new(accounts.amm_target_orders.key(), false), // 4: amm_target_orders_info
        ...
        AccountMeta::new_readonly(accounts.market_program.key(), false), // 7: market_program_info
        AccountMeta::new(accounts.market.key(), false),          // 8: market_info
        AccountMeta::new(accounts.market_bids.key(), false),     // 9: market_bids_info
        AccountMeta::new(accounts.market_asks.key(), false),     // 10: market_asks_info
        AccountMeta::new(accounts.market_event_queue.key(), false), // 11: market_event_queue_info
        AccountMeta::new(accounts.market_coin_vault.key(), false), // 12: market_coin_vault_info
        AccountMeta::new(accounts.market_pc_vault.key(), false), // 13: market_pc_vault_info
        AccountMeta::new_readonly(accounts.market_vault_signer.key(), false), // 14: market_vault_signer
