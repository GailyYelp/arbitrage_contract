...
impl Protocol {
    pub const ALL: [Protocol; CONTRACT_PROTOCOL_COUNT] = [
        ...
        Protocol::Rise,
        Protocol::Dradex,
        Protocol::BonfidaDexV4,
        Protocol::GfxSsl,
        Protocol::DumpFun,
        Protocol::JupiterPerpetuals,
        Protocol::TokenMillV2,
        Protocol::YeetAmm,
        Protocol::SegaCpmm,
        Protocol::SugarMoney,
        Protocol::SwapIoClmm,
    ...
    pub const fn contract_id(self) -> u8 {
        match self {
            ...
            Protocol::Rise => 95,
            Protocol::Dradex => 96,
            Protocol::BonfidaDexV4 => 97,
            Protocol::GfxSsl => 98,
            Protocol::DumpFun => 99,
            Protocol::JupiterPerpetuals => 100,
            Protocol::TokenMillV2 => 101,
            Protocol::YeetAmm => 102,
            Protocol::SegaCpmm => 103,
            Protocol::SugarMoney => 104,
            Protocol::SwapIoClmm => 105,
            Protocol::Cube => 106,
            Protocol::Limo => 107,
            Protocol::Symmetry => 108,
            Protocol::RunnerRodeo => 109,
        }
    }
    ...
    pub const fn manifest_name(self) -> &'static str {
        match self {
            ...
            Protocol::Rise => "Rise",
            Protocol::Dradex => "Dradex",
            Protocol::BonfidaDexV4 => "BonfidaDexV4",
            Protocol::GfxSsl => "GfxSsl",
            Protocol::DumpFun => "DumpFun",
            Protocol::JupiterPerpetuals => "JupiterPerpetuals",
            Protocol::TokenMillV2 => "TokenMillV2",
            Protocol::YeetAmm => "YeetAmm",
            Protocol::SegaCpmm => "SegaCpmm",
            Protocol::SugarMoney => "SugarMoney",
            Protocol::SwapIoClmm => "SwapIoClmm",
            Protocol::Cube => "Cube",
            Protocol::Limo => "Limo",
            Protocol::Symmetry => "Symmetry",
            Protocol::RunnerRodeo => "RunnerRodeo",
        }
    }
}
